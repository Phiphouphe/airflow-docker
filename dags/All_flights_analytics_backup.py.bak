...
with DAG(
    ...
    task_check_analytics_ready >> extraction_db >> extractor_array >> [join_tables_raw, join_tables_scheduled] >> remove_columns >> apply_business_functions >> version_selector >> loading